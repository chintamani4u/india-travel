 ...
 * Class EnMap.
 */
class LtMap implements MenuMapInterface {

  public $menuName = 'menu-lithuania';
  public $langCode = 'lt';
  public $domainCode = 'lt';
