 ...
 * Class RuMap.
 */
class RuMap implements MenuMapInterface {

  public $menuName = 'menu-russia';
  public $langCode = 'ru';
  public $domainCode = 'ru';
  ...
  public function getTopLevelMenuLinks() {
    $menus = [
      ...
      [
        'weight' => 6,
        'link_title' => 'Устойчивое развитие',
        'existing_title' => FALSE,
        'off_canvas' => TRUE,
      ...
      [
        ...
        'existing_title' => FALSE,
        'off_canvas' => TRUE,
        'link_path' => 'https://perspectives.tieto.com/blog',
        'external' => TRUE,
      ],
    ];
