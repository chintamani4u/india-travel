<!-- below code is commented to remove old cookie control from the site -->
<!-- div id="cccwr">
    <div id="ccc-state" class="ccc-pause">
        <div id="ccc-icon">
            <button>
                <span><?php print t('Cookie Settings');?></span>
            </button>
        </div>
        <div class="ccc-widget">
            <div class="ccc-outer">
                <div class="ccc-inner">
                    <h2><?php print t('Cookie Settings');?></h2>
                    <div class="ccc-content">
                      ...
                      <?php /*
                        <p class="ccc-about">
                            <small>
                                <?php print t('About this tool');?></a>
                            </small>
                        </p>
                      */ ?>
                        <a class="ccc-icon" target="_blank"
                        title="<?php print t('About Cookie Settings');?>"><?php print t('About Cookie Settings');?></a>
