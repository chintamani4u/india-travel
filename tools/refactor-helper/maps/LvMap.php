 ...
 * Class LvMap.
 */
class LvMap implements MenuMapInterface {

  public $menuName = 'menu-latvia';
  public $langCode = 'lv';
  public $domainCode = 'lv';
  ...
  public function getTopLevelMenuLinks() {
    $menus = [
      ...
      [
        'weight' => 6,
        'link_title' => 'Korporatīvā ilgtspēja',
        'existing_title' => FALSE,
        'off_canvas' => TRUE,
