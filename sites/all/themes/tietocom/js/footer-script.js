...
(function ($, Drupal, window, document, undefined) {
  $(document).ready(function () {
    ...
    $('.tieto-lightbox-trigger').click(function(e) {
      ...
      $('#tieto-lightbox .close').on('click touchstart', function() {
    ...
    // DO NOT USE THIS, because on mobile, this will close the window automatically!
    ...
    function carouselMainImage() {
      $("img.carousel-main").css({"min-height": $(".flex-nav-container").innerHeight()}).height("auto").width("auto");
    }
