...
function tietocom_preprocess_html(&$variables, $hook) {
  ...
  */
  ...
  drupal_add_html_head_link(array('rel' => 'shortcut icon', 'href' => "/sites/default/files/tieto_favicon.ico", 'type' => $type));
   ...
   * */
  drupal_add_css(
		path_to_theme() . '/css/font-awesome.css'
	);
...
// Below code added by Zainul while create new concept pages for careers.
// Do we have a node?
...
function tietocom_preprocess_panels_pane(&$variables) {
  ...
  //TIET-2440: Contact form title transaltion is not working
  if(sizeof($display->context)) {
    if ($display->context['panelizer']->data->type == 'contact') {
     $title = $display->title;
     $variables['display']->title = t($title);
    }
  }
}
    ...
    case 'footer':
      if (theme_get_setting('footer_logo')) {
        if (file_exists($footer_logo = drupal_get_path('theme', 'tietocom') . '/footer-logo.png')) {
          ...
          $vars['footer_logo'] = file_create_url(drupal_get_path('theme', 'tietocom') . '/logofooter.png');
        }
      }
      break;
  }
...
function tietocom_preprocess_views_view(&$vars) {
  ...
  if ($view->name == 'news_room_container' && $view->current_display == 'news_room_container_box') {
    //
	...
	switch($node->language) {
      case 'en':
        $vars['twitter'] = views_embed_view('tweets','newroomblock');
		$vars['stock_exchange_releases'] = views_embed_view('newsroomlatestrelease','stock_exchange_releases');
		$vars['twitter_link'] = 'https://twitter.com/TietoCorp'; 
		$vars['press_release_link'] = "https://www.tieto.com/news?f%5B0%5D=field_news_type%3A88&f%5B1%5D=field_news_type%3A12691";
		$vars['stock_exchange_link'] = "https://www.tieto.com/news?f[0]=field_news_type%3A87";
		$vars['managers_transaction_link'] = "https://www.tieto.com/news?f[0]=field_news_type%3A14986";
		$vars['trade_release_link'] = "https://www.tieto.com/news?f[0]=field_news_type%3A12696";
		$vars['other_release_link'] = "https://www.tieto.com/news?f[0]=field_news_type%3A90";
      break;

      case 'fi':
        $vars['twitter'] = views_embed_view('tweets','tweets_fi');
		$vars['stock_exchange_releases'] = views_embed_view('newsroomlatestrelease','stock_exchange_releases');
		$vars['twitter_link'] = 'https://twitter.com/tietosuomi';
		$vars['press_release_link'] = "https://www.tieto.fi/uutiset?f[0]=field_news_type%253A87&f[1]=field_news_type%253A88&f[2]=field_news_type%3A88";
		$vars['managers_transaction_link'] = "https://www.tieto.com/news?f[0]=field_news_type%3A14986";
		$vars['stock_exchange_link'] = "https://www.tieto.fi/uutiset?f[0]=field_news_type%3A87"; 
		$vars['trade_release_link'] = "https://www.tieto.fi/uutiset?f[0]=field_news_type%3A12696";
		$vars['other_release_link'] = "https://www.tieto.fi/uutiset?f[0]=field_news_type%3A90";
      break;
	  
	   case 'nn':
        $vars['twitter'] = views_embed_view('tweets','tweets_no');
		$vars['stock_exchange_releases'] = views_embed_view('newsroomlatestrelease','en_stock_exchange_releases');
		$vars['twitter_link'] = 'https://twitter.com/tietonorway';
		$vars['press_release_link'] = "https://www.tieto.no/nyheter?f%255B0%255D=field_news_type%253A88&f[0]=field_news_type%3A88";
		$vars['managers_transaction_link'] = "https://www.tieto.com/news?f[0]=field_news_type%3A14986";
		$vars['stock_exchange_link'] = "https://www.tieto.com/news?f%5B0%5D=field_news_type%3A87"; 
		$vars['trade_release_link'] = "https://www.tieto.no/nyheter?f%255B0%255D=field_news_type%253A88&f[0]=field_news_type%3A12696";
		$vars['other_release_link'] = "https://www.tieto.no/nyheter?f%255B0%255D=field_news_type%253A88&f[0]=field_news_type%3A90";
      break;
	  
	   case 'sv':
        $vars['twitter'] = views_embed_view('tweets','tweets_se');
		$vars['stock_exchange_releases'] = views_embed_view('newsroomlatestrelease','en_stock_exchange_releases');
		$vars['twitter_link'] = 'https://twitter.com/tietosverige';
		$vars['press_release_link'] = "https://www.tieto.se/nyheter?f[0]=field_news_type%3A88";
		$vars['managers_transaction_link'] = "https://www.tieto.com/news?f[0]=field_news_type%3A14986";
		$vars['stock_exchange_link'] = "https://www.tieto.com/news?f%5B0%5D=field_news_type%3A87"; 
		$vars['trade_release_link'] = "https://www.tieto.se/nyheter?f[0]=field_news_type%3A12696";
		$vars['other_release_link'] = "https://www.tieto.se/nyheter?f[0]=field_news_type%3A90";
      break;
