 ...
 * Class NlMap.
 */
class NlMap implements MenuMapInterface {

  public $menuName = 'menu-metherlands';
  public $langCode = 'nl';
  public $domainCode = 'nl';
