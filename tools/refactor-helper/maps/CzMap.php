 ...
 * Class CzMap.
 */
class CzMap implements MenuMapInterface {

  public $menuName = 'menu-czech';
  public $langCode = 'cs';
  public $domainCode = 'cz';
  ...
  public function getTopLevelMenuLinks() {
    $menus = [
      [
        ...
        'off_canvas' => FALSE,
        'link_path' => 'tieto-o-nas',
        'external' => FALSE,
      ],
      [
        'weight' => 3,
        'link_title' => 'Zákazníci',
        'existing_title' => FALSE,
        'off_canvas' => FALSE,
      ...
      [
        ...
        'existing_title' => FALSE,
        'off_canvas' => FALSE,
        'link_path' => 'https://jobs.tieto.cz',
        'external' => TRUE,
      ],
      [
        'weight' => 6,
        'link_title' => 'Udržitelnost',
        'existing_title' => FALSE,
        'off_canvas' => TRUE,
      ...
      [
        ...
        'existing_title' => FALSE,
        'off_canvas' => TRUE,
        'link_path' => 'https://jobs.tieto.cz/akce',
        'external' => TRUE,
      ],
      [
        'weight' => 9,
